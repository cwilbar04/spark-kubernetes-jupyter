...
CALL ${schema:CW_SANDBOX_CONTRACT_MONITORING_IL_CREATE_TABLE}.DROP_TABLE_IF_EXISTS('${tbl:CW_SANDBOX_CONTRACT_MONITORING_IL_CREATE_TABLE}');

CREATE MULTISET TABLE ${tbl:CW_SANDBOX_CONTRACT_MONITORING_IL_CREATE_TABLE} ,
     NO BEFORE JOURNAL,
     NO AFTER JOURNAL,
     CHECKSUM = DEFAULT,
