SELECT 1 FROM dbc.TablesV WHERE '"' || TRIM(databasename) || '"."' || TRIM(tablename) || '"' = '${tbl:CW_SANDBOX_CONTRACT_MONITORING_IL_CREATE_TABLE}';
IF ACTIVITYCOUNT = 1 THEN GOTO do_nothing
CREATE MULTISET TABLE IF NOT EXISTS ${tbl:CW_SANDBOX_CONTRACT_MONITORING_IL_CREATE_TABLE} ,
     NO BEFORE JOURNAL,
     NO AFTER JOURNAL,
     CHECKSUM = DEFAULT,
     ...
     (
      ...
      li_num DECIMAL(4,0),
      hcpcs_c ${prov_finc_id_list_completed} pt_cd CHAR(6) CHARACTER SET LATIN NOT CASESPECIFIC,
